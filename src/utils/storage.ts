import { buyerSeeds, categorySeeds, offerSeeds, ratingSeeds, reservationSeeds, supplierSeeds } from "../data/seeds";
import type { BuyerProfile, Category, Offer, Rating, Reservation, SessionUser, SupplierProfile } from "../types";
...
const CURRENT_SEED_VERSION = "2026-06-09-v2";
